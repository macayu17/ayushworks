          ...
          >
            <div className="contact-info">
              ...
              <div className="social-links">
                <a href="https://github.com/macayu17" className="social-link" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/anayush14/" className="social-link" target="_blank" rel="noopener noreferrer">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
